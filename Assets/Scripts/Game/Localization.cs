        ...
        _data.SetData = new Dictionary<string, DataParams>
        {
            ...
            },
            {
                "BunkerBuildings", new DataParams
                {
                    Text = new List<string>
                    {
                        "Теплица", "Сломанная теплица", "Офисный кабинет", "Столовая", "Химическая лабаратория", "Склад с провизией", "Лабаратория для исследований", "Парикмахерская", "Пустой склад", "Душевая комната",
